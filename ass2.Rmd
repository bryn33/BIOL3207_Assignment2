...
# When looking at the meta-regression model to test for time-lag bias we can see that time-lag explains 0.022% of variation in yi. This indicates that there is very minimal evidence of time-lag bias across the pooling of the studies.Additionally, when looking at the meta-regression model to test for file-draw biases we can see that the bias explains 0% of the variation in yi. THis indicates that there is no evidence of file-draw bias across the pooling of the studies.
#
